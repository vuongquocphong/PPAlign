import numpy as np
from ppalign.utils import yield_overlaps, length_vi
...
class Encoder:
    ...
    def transform(self, sents, num_overlaps, lang):
        ...
        len_vecs = [len(line.encode("utf-8")) for line in overlaps] if lang == 'zh' else [length_vi(line) for line in overlaps]
