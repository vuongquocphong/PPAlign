...
def second_pass_align(src_vecs,
	...
	Args:
		...
		converted_src: words list of source sentences after transliteration step.
		converted_tgt: words list of target sentences.
		src_word_len: number of words in each sentences.
		tgt_word_len: number of words in each sentences.
